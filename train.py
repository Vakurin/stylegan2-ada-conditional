...
def setup_training_options(
    ...
    cfg_specs = {
        ...
        '8gb-gpu':          dict(ref_gpus=2, kimg=15000,  mb=4, mbstd=4, fmaps=1,  lrate=0.002,     gamma=10,   ema=10,  ramp=0.05, map=8),
...
def main():
    ...
    group.add_argument('--cfg',   help='Base config (default: auto)', choices=['auto', '8gb-gpu','11gb-gpu','11gb-gpu-complex', '24gb-gpu','24gb-gpu-complex', '48gb-gpu', 'stylegan2', 'paper256', 'paper512', 'paper1024', 'cifar', 'cifarbaseline', 'aydao'])
